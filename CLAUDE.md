...
**阶段**:W7–8 自动化流水线（完成）
**目标**:6 小时版本探测、跨版本继承、SAFE 复检、候选预翻译、自动 PR、发布门禁与 EOL 支持矩阵全部落地
**本阶段禁止**:自动合并、低继承率强行适配、向 LLM 发送 DANGER/FRAGILE、降低 schema 或冒烟断言
**下一阶段**:W9–10 CLI 原生二进制 B/C 层与 surface mapper
